...
class ReportLabUtils:
    ...
    def build_annual_report(
        ...
        news_summarization: Annotated[
            str,
            "a paragraph of text: the company's news_summarization from pulic news from the last 3 months",
        ],
        ...
        filing_date: Annotated[str, "filing date of the analyzed financial report,YYYY-MM-DD"]="2024-07-22",
    ) -> str:
        """
        ...
        """
        pdfmetrics.registerFont(TTFont('simhei', os.path.join(dir_path, 'fonts/SimHei.ttf')))
        try:
            # 2. 创建PDF并插入图像
            # 页面设置
            ...
            name = TuShareUtils.get_stock_info(ticker_symbol)["name"][0]
            ...
            df = TuShareUtils.get_financial_metrics(ticker_symbol, years=5)
